...
from integration.integrations import handleGCalAuthResponse
...
class TestIntegration_handleGCalAuthResponse(unittest.TestCase):
    ...
    def test_withAuthorizedUser_withStateInDB_savesCredentialsToDB(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withAuthorizedUser_withStateInDB_callsCreateGoogleCalendarFunction(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withAuthorizedUser_withStateInDB_returnsRedirectToManHallPage(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
