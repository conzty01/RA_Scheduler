...
class TestServer_googleLoggedIn(unittest.TestCase):
    def setUp(self):
    ...
    def test_withMissingToken_returnsFalse(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withInvalidResponse_returnsFalse(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withNoExistingUser_createsNewUser(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withExistingUser_logsInExistingUser(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withNewUser_associatesWithExistingRARecord(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
