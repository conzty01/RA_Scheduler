...
class TestServer_config(unittest.TestCase):
    def setUp(self):
    ...
    def test_loadsLogLevelFromEnvironment(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_configuresLoggingAsExpected(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_loadsAppConfigurationFromEnvironment(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_createsBootstrapApp(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_registersExpectedBlueprints(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_createsSQLAlchemyConnection(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_createsLoginManager(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
