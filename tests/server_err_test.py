...
class TestServer_err(unittest.TestCase):
    def setUp(self):
    ...
    # ------------------------------
    def test_whenCalledFromClient_passesExpectedInformationToRenderer(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
    ...
    # ------------------------------
    def test_whenCalledFromServer_passesExpectedInformationToRenderer(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
