...
class TestStaff_removeStaffer(unittest.TestCase):
    def setUp(self):
    ...
    def test_withAuthorizedUser_ifClientDoesNOTBelongToTheSameHall_returnsNotAuthorizedResponse(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
    ...
    def test_withAuthorizedUser_withValidRARecord_updatesRARecord(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
