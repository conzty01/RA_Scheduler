...
class TestHallBP_getHallSettings(unittest.TestCase):
    ...
    def test_whenProvidedHallUserIsAssociatedWith_setsProvidedHallAsSelected(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        self.fail("Not Implemented")

    def test_whenProvidedHallUserIsAssociatedWith_returnsRedirectToIndex(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        self.fail("Not Implemented")

    def test_whenProvidedHallUserIsNOTAssociatedWith_doesNotInteractWithDB(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        self.fail("Not Implemented")

    def test_whenProvidedHallUserIsNOTAssociatedWith_returnsRedirectToIndex(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        self.fail("Not Implemented")
