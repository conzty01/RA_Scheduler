...
class TestStaff_addStaffer(unittest.TestCase):
    def setUp(self):
    ...
    def test_withAuthorizedUser_withExistingRARecord_updatesExistingRecord(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withAuthorizedUser_withoutExistingRARecord_createsNewRARecord(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
