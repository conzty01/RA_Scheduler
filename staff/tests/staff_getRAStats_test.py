...
class TestStaff_getRAStats(unittest.TestCase):
    def setUp(self):
    ...
    # ------------------------------
    def test_whenCalledFromClient_returnsStaffInfoInExpectedJSONFormat(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
    ...
    # ------------------------------
    def test_whenCalledFromServer_returnsStaffInfoInExpectedFormat(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_whenCalledFromServer_withMaxBreakDutyAssigned_usesMaxBreakDuty(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
