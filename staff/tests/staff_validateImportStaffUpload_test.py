...
class TestStaff_validateImportStaffUpload(unittest.TestCase):
    def setUp(self):
    ...
    def test_removesProblematicCharacters(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withMissingPartListItems_returnsAppropriateReason(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withInvalidEmail_returnsAppropriateReason(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withInvalidDate_returnsAppropriateReason(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withInvalidColor_returnsAppropriateReason(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withInvalidRole_returnsAppropriateReason(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withValidPartsList_returnsExpectedResponse(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
