...
class TestStaff_changeStaffInfo(unittest.TestCase):
    def setUp(self):
    ...
    def test_withAuthorizedUser_ifUserDoesNotBelongToSameStaff_returnsNotAuthorizedResponse(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withAuthorizedUser_ifRARecordDoesNOTExist_returnsNotAuthorizedResponse(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withAuthorizedUser_callsAddRAPointModifierMethod(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withAuthorizedUser_updatesRARecord(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
