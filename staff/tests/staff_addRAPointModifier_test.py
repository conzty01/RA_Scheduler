...
class TestStaff_addRAPointModifier(unittest.TestCase):
    def setUp(self):
    ...
    def test_withNoPreviousModifier_createsNewPointModifierRecord(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withPreviousModifier_ifSetIsTrue_overwritesExistingPointModifier(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass

    def test_withPreviousModifier_ifSetIsFalse_incrementsExistingPointModifier(self):
        # -- Arrange --
        # -- Act --
        # -- Assert --
        pass
